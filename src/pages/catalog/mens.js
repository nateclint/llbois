...
function Mens(props) {
    ...
    const [data, setData] = useState(mens)
    const [option, setOption] = useState('normal')

    useEffect(() => {
        if (vendor) {

            let filter = mens.filter((item) => {
            ...
            <div className="nav-breadcrumb">
                <div className="container">
                    <nav aria-label="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Mens</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div className="container-indent mx-4">
                            <div className="container">
                                <div className="shop-block-title">
                                    <h4 className="text-uppercase">Mens {'(' + data?.length + ' items)'}</h4>
                                </div>

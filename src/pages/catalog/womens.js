...
function Womens(props) {
    ...
    const [data, setData] = useState(womens)
    const [option, setOption] = useState('normal')

    useEffect(() => {
        if (vendor) {

            let filter = womens.filter((item) => {
                ...
                <div className="container">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Womens </li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div className="container-indent mx-4">
                            <div className="container">
                                <div className="shop-block-title">
                                    <h4 className="text-uppercase">Womens {'(' + data?.length + ' items)'}</h4>
                                </div>
